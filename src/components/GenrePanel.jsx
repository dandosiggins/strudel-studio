...
const GENRES = [
  ...
  note("c1 ~ c1 ~ eb1 ~ c1 ~").sound("moog").gain(0.3).lpf(400)
)`,
      },
      {
  ...
  note("c1 ~ c1 ~ eb1 ~ c1 ~").sound("moog").gain(0.3).lpf(sine.range(200,800).slow(8)),
  ...
  note("~ c4 ~ c4").sound("juno").gain(0.7).room(0.3)
      ...
      },
      {
        title: 'Moog Bassline',
        concept: 'Moog bass locked with kick',
        explanation: 'A punchy moog bass locks with the kick — the engine of house music',
        code: `stack(
  sound("bd bd bd bd").gain(0.85),
  sound("~ hh ~ hh").gain(0.5),
  note("~ c4 ~ c4").sound("juno").gain(0.7).room(0.3),
  note("c2 ~ c2 c2 ~ c2 c2 ~").sound("moog").gain(0.3).lpf(800)
)`,
      },
      {
  ...
  note("c2 ~ c2 c2 ~ c2 c2 ~").sound("moog").gain(0.3).lpf(sine.range(300,1200).slow(8))
)`,
      },
    ],
  },
